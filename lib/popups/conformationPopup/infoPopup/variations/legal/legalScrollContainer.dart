...
class LegalScrollContainer extends StatefulWidget {
  final VoidCallback endScroll;
  const LegalScrollContainer({super.key, required this.endScroll});
...
class _LegalScrollContainerState extends State<LegalScrollContainer> {
  ...
  Widget build(BuildContext context) {
    TextStyle defaultStyle =
        TextStyle(color: Colors.grey[350], fontSize: 17.8);
    TextStyle linkStyle = const TextStyle(color: Colors.blue);
    return Container(
      decoration: BoxDecoration(color: Colors.grey.withAlpha(40), borderRadius: BorderRadius.circular(8)),
